...
class AdminMedicationExchangeModel extends Equatable {
  const AdminMedicationExchangeModel({
    this.id,
  ...
  factory AdminMedicationExchangeModel.fromJson(Map<String, dynamic> map) {
    return AdminMedicationExchangeModel(
      id: map['id'] as String?,
  ...
  AdminMedicationExchangeModel copyWith({
    String? id,
    String? description,
